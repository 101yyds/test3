...
`include "../../sources_1/new/uart_def.v"
...
parameter BASE_RAM_INIT_FILE = "C://Users//Kevin//Desktop//nscscc2023LA//source//pref//kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "C://Users//Kevin//Desktop//nscscc2023LA//source//lab2//ext.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
